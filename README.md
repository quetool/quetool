...
- LinkedIn: [https://www.linkedin.com/in/alfredorinaudo/](https://www.linkedin.com/in/alfredorinaudo/)
...
**Web3:** Wallet SDKs, signing, JSON-RPC, WalletConnect, blockchain APIs, `web3dart`, `on_chain`, `eth_sig_util`, `bip39`, `bip32`, `pointycastle`, `crypto`, `bech32`, `convert`
**Build/Release:** GitHub Actions, Fastlane, CI/CD, monorepos, pub.dev publishing  
...
### Kraken Exchange (Remote, US) - [https://pro.kraken.com](https://pro.kraken.com)
...
### Multiplica (Remote, Spain) - [https://bcntdc.zurich.com](https://bcntdc.zurich.com)
...
### Loka Inc. (Remote, US) - [https://www.loka.com](https://www.loka.com)
#### *Flutter Engineer*
**Nov 2020 – Jul 2021**
...
- **BSc in Computer Science** — University of Perugia (Italy)
- **English C2 (EFSET, 2021)** — [https://www.efset.org/cert/4a3NAS](https://www.efset.org/cert/4a3NAS)

---

## Proof of Work

- [GitHub personal page](https://github.com/quetool)
- [Issues opened on Flutter repo (longevity proof)](https://github.com/flutter/flutter/issues?q=is%3Aissue%20author%3A%40me%20sort%3Acreated-asc)
- [Camera Roll Uploader package (LokaHQ)](https://github.com/LokaHQ/camera_roll_uploader)
- [Reown/WalletConnect Flutter monorepo](https://github.com/reown-com/reown_flutter)
- [WalletConnect legacy repo (signing)](https://github.com/WalletConnect/WalletConnectFlutterV2)
- [WalletConnect legacy repo (dApps)](https://github.com/WalletConnect/Web3ModalFlutter)
- [WalletConnect legacy modal repo](https://github.com/WalletConnect/WalletConnectModalFlutter)
- [All my PRs (oldest first)](https://github.com/pulls?q=is%3Apr+author%3Aquetool+archived%3Afalse+sort%3Acreated-asc)
